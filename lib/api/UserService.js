...
async function get(url, params = {}) {
  return instance.get(url, {
    params,
    headers: {
      Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJkZjMwODVjZC0xZGQ0LTQ3NGQtODk3Mi1lNjVkNzE2YWY5MDYiLCJpYXQiOjE3MzI1OTk2MDIsImV4cCI6MTczMjY4NjAwMn0.GA87fq04p3dZUFMiIlzYPZ-1Wsk2XXnIGGS706-d8m0`, // Authorization 헤더에 토큰 추가
    },
  });
}
...
// 구매한 내 포토 카드 전체 조회
export async function getMyPhotoCardList({ page, pageSize, filter, keyword }) {
  const params = {
    page,
    pageSize,
    filter,
